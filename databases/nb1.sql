...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Már 30. 21:57
...
CREATE TABLE `labdarugo` (
  ...
  `utonev` varchar(100) DEFAULT NULL,
...
--
ALTER TABLE `labdarugo`
  ADD CONSTRAINT `fk_labdarugo_klub` FOREIGN KEY (`klubid`) REFERENCES `klub` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_labdarugo_poszt` FOREIGN KEY (`posztid`) REFERENCES `poszt` (`id`) ON UPDATE CASCADE;
COMMIT;
